...
# 5. PC            YYYYMMDD-Race-rpc.pdf    # rear postcards rotaged
...
# 4&5 - copy and rotate the postcard file to create back
%-pc.pdf: 
	echo x
...
clean:
	rm -rf *.pdf* *2018*.csv *2019*.csv tmp
